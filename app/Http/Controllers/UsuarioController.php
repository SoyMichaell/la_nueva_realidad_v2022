...
class UsuarioController extends Controller
{
    public function index(Request $request)
    {
        ...
        $usuarios = DB::table('users')
            ->select('users.id as idUser','tipo_documento','numero_documento','nombre','apellido','email',
            'telefono','rol','slug','estado','nombre_rol','correo_institucional','nivel_programa','programa','roles.id as idRol')
