                ...
                <div class="card card-primary">
                    ...
                    <div class="card-body">
                        <form action="{{ url("diagnostico/{$empresa->nit}/objestrategico") }}" method="post">
                            @csrf
                            @method('PUT')
                            <textarea class="form-control" name="objestrategico" id="objestrategico">{{$exist_diagnostico_empresa->objetivo_estrategio}}</textarea>
                            <button class="btn btn-primary mt-2 mb-2" type="submit">Guardar</button>
                        </form>
                    </div>
                </div>
                        ...
                        <div id="accordion">
                            <div class="accordion">
                                ...
                                <div class="accordion-body collapse show" id="panel-body-1" data-parent="#accordion">
                                    <form action="{{ url("diagnostico/{$empresa->nit}/perspectivacrecimientodesarrollo") }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <!--pregunta1-->
                                        <div class="alert alert-light">
                                            ...
                                            <p>Respuesta: Si</p>
                                            <textarea class="form-control" name="preguntacd1" id="preguntacd1">{{ old('preguntacd1') }} {{$exist_diagnostico_empresa->preguntacd1}}</textarea>
                                        </div>
                                        <!--pregunta1.1-->
                                        <div class="alert alert-light">
